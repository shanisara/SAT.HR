...
namespace SAT.HR.Controllers
{
    public class ExcelImportController : Controller
    {
        ...
        public JsonResult UploadExcel(HttpPostedFileBase FileUpload, int modelMapping)
        {
            ...
            string[] ProvidentFundHeader = { "รหัสพนักงาน", "ปีบัญชี", "วันที่เปลี่ยนแปลงเงินสะสม", "รหัสเงินสะสม", "รหัสเงินสมทบ", "ผู้รับผลประโยชน์ลำดับที่ 1", "ผู้รับผลประโยชน์ลำดับที่ 2", "ผู้รับผลประโยชน์ลำดับที่ 3", "ผู้รับผลประโยชน์ลำดับที่ 4", "ผู้รับผลประโยชน์ลำดับที่ 5", "ผู้รับผลประโยชน์ลำดับที่ 1 ร้อยละ/เท่า", "ผู้รับผลประโยชน์ลำดับที่ 2 ร้อยละ/เท่า", "ผู้รับผลประโยชน์ลำดับที่ 3 ร้อยละ/เท่า", "ผู้รับผลประโยชน์ลำดับที่ 4 ร้อยละ/เท่า", "ผู้รับผลประโยชน์ลำดับที่ 5 ร้อยละ/เท่า" };
            string[] HomeRentalHeader = { "รหัสพนักงาน","ปีบัญชี", "รหัสประเภทค่าเช่า", "รหัสส่วน", "ระดับขั้น", "วันที่เริ่ม", "วันที่สิ้นสุด", "จำนวนเงิน", "หมายเหตุ" };
            string[] MedicalHeader = { "รหัสพนักงาน", "ปีบัญชี","รหัสประเภทสิทธิ", "รหัสผู้รับ", "ชื่อผู้รับ", "เลขบัตรประชาชน" ,"วันที่เข้ารักษา", "ค่าห้อง+ค่าอาหาร", "ค่ารักษาพยาบาล","หมายเหตุ" };
            string[] CremationHeader = { "รหัสพนักงาน", "ปีบัญชี", "รหัสประเภทสมาชิก", "เลขสมาชิก", "วันสมัคร", "ผู้รับเงินสงเคราะห์", "ผู้รับผลประโยชน์ลำดับที่ 1", "ผู้รับผลประโยชน์ลำดับที่ 2", "ผู้รับผลประโยชน์ลำดับที่ 3", "ผู้รับผลประโยชน์ลำดับที่ 4", "ผู้รับผลประโยชน์ลำดับที่ 5" };
                        ...
                        foreach (DataRow line in dtable.Rows)
                        {
                            try
                            {
                                if (!String.IsNullOrEmpty(line[0].ToString()))
                                {
                                    ...
                                    l.BpBeneficiary1Percent = Convert.ToInt32(line[10].ToString());
                                    l.BpBeneficiary2Percent = Convert.ToInt32(line[11].ToString());
                                    l.BpBeneficiary3Percent = Convert.ToInt32(line[12].ToString());
                                    l.BpBeneficiary4Percent = Convert.ToInt32(line[13].ToString());
                                    l.BpBeneficiary5Percent = Convert.ToInt32(line[14].ToString());
