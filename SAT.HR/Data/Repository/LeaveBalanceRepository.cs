...
namespace SAT.HR.Data
{
    ...
    {
        //public LeaveBalanceViewModel GetLeaveBalanceByUser(int userid)
        //{
        ...
        //public LeaveBalanceViewModel GetLeaveBalanceByID(int userid, int id)
        //{
        ...
        //public ResponseData AddByEntity(LeaveBalanceViewModel data)
        //{
        //    using (SATEntities db = new SATEntities())
        //    {
        ...
        //public ResponseData UpdateByEntity(LeaveBalanceViewModel newdata)
        //{
        //    using (SATEntities db = new SATEntities())
        //    {
        //        ResponseData result = new Models.ResponseData();
